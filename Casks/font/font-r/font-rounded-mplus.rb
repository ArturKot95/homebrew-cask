cask "font-rounded-mplus" do
  version "20150529"
  sha256 "e854e60e3ed5dfe5e8ee4d171408942d6560f9fb0931c05cbeeb3a6c9c65fecb"

  url "https://ftp.iij.ad.jp/pub/osdn.jp/users/8/8574/rounded-mplus-#{version}.zip",
      verified: "ftp.iij.ad.jp/pub/osdn.jp/users/8/8574/"
  name "Rounded M+"
  homepage "http://jikasei.me/font/rounded-mplus/"

  livecheck do
    url "http://jikasei.me/font/rounded-mplus/about.html"
    regex(/href=.*?rounded-mplus-(\d+(?:\.\d+)*)\.zip/i)
  end
